	...
	<div class="container-fluid"> 
		...
		<div class="row">
			...
			<div class="col-sm-9">
                ...
                <form method="post" action="{{ route('customer.confirm_order') }}">
                    
                    {{ csrf_field() }}

                    <h3 style="text-align: center;">Insert Customer Table No:</h3><br>
                        ...
                        <button type="submit" class="btn btn-success pull-right" style="margin-right: 80px;">Submit Order</button>
